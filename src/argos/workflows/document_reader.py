...
a validated `RelevanceCall`. Forces JSON output via Anthropic
...
def _tool_schema() -> dict[str, Any]:
    return {
        ...
        "input_schema": RelevanceCall.model_json_schema(),
    }
...
def run_document_reader(
    ...
    *,
    ...
    for attempt in range(max_retries + 1):
        ...
        try:
            call = RelevanceCall.model_validate(tool_input)
