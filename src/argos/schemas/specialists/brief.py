...
SpecialistName = Literal["coverage", "liability", "reserve", "recovery", "closure"]
...
class SpecialistRecommendationHeadline(BaseModel):
...
class ClaimBrief(BaseModel):
    ...
    specialist_recommendations_summary: list[SpecialistRecommendationHeadline] = Field(
