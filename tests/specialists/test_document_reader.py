...
- MaterialityCall schema invariants (excerpt iff material,
  posture iff material).
...
class TestMaterialityCallSchema:
    def test_material_true_requires_excerpt(self):
    ...
    def test_material_false_forbids_excerpt(self):
        with pytest.raises(ValidationError, match="text_excerpt"):
            MaterialityCall(
                document_id="d1",
                material=False,
    ...
    def test_material_true_requires_posture(self):
    ...
    def test_material_false_forbids_posture(self):
        with pytest.raises(ValidationError, match="posture_changed"):
            MaterialityCall(
                document_id="d1",
                material=False,
    ...
    def test_minimal_material_true(self):
    ...
    def test_minimal_material_false(self):
        call = MaterialityCall(
            document_id="d1",
            material=False,
            posture_changed=None,
